 ...
 * 画出心电曲线图
 */
public class LineReadView extends View {
    ...
    public LineReadView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }  
  
    public LineReadView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    }
      
    public LineReadView(Context context) {
        super(context);
    }
