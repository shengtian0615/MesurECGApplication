...
public class ECGWaveHScrollView extends HorizontalScrollView {
	...
	public ECGWaveHScrollView(Context context) {
		super(context);
	 ...
	 */
	@SuppressWarnings("deprecation")
	public ECGWaveHScrollView(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		mGestureDetector = new GestureDetector(new HScrollDetector());
		setFadingEdgeLength(0);
	 ...
	 */
	@SuppressWarnings("deprecation")
	public ECGWaveHScrollView(Context context, AttributeSet attrs, int defStyle) {
