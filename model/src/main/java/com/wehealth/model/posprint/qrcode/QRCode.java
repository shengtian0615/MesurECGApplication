...
public class QRCode {
    ...
    public static int getMinimumQRCodeTypeNumber(String data, int errorCorrectLevel) {
    ...
    public static QRCode getFixedSizeQRCode(String data, int errorCorrectLevel, int typeNumber) {
