...
import com.wehealth.model.util.SampleDotInt;
import com.wehealth.model.util.ZipUtil;

/**
 * 长时间测试的心电显示
 */
public class ECGWave2hFragment extends Fragment implements OnClickListener, OnCheckedChangeListener{
...
//	private RadioButton ecgWG_5, ecgWG_10, ecgWG_20;
	...
	private SampleDotInt sampleDot[];
...
//		line3 = (LineReadView) getView().findViewById(R.id.read_line3);
//		line4 = (LineReadView) getView().findViewById(R.id.read_line4);
//		line5 = (LineReadView) getView().findViewById(R.id.read_line5);
//		line6 = (LineReadView) getView().findViewById(R.id.read_line6);
//		line7 = (LineReadView) getView().findViewById(R.id.read_line7);
//		line8 = (LineReadView) getView().findViewById(R.id.read_line8);
//		line9 = (LineReadView) getView().findViewById(R.id.read_line9);
//		line10 = (LineReadView) getView().findViewById(R.id.read_line10);
//		line11 = (LineReadView) getView().findViewById(R.id.read_line11);
		...
		sampleDot = new SampleDotInt[12];
		for(int i = 0; i < drawWaveNum; i++){
			sampleDot[i] = new SampleDotInt(ECG_SAMPLE_RATE, DESTINATION_SAMPlE_RATE);
		}
	...
	private int[] sampleReadEcgData(int[] srcData, int lead){
		List<Integer> list = sampleDot[lead].SnapshotSample(srcData);
